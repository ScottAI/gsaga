...
func TestSuccessfullyExecTwoSteps(t *testing.T) {
	...
	require.NoError(t, s.AddSubTx(&SubTx{Name: "first", Func: m.f, CompensateFunc: comp.f}))
	require.NoError(t, s.AddSubTx(&SubTx{Name: "second", Func: m2.f, CompensateFunc: comp.f}))
...
func TestCompensateCalledWhenError(t *testing.T) {
	...
	require.NoError(t, s.AddSubTx(&SubTx{Name: "single", Func: m.f, CompensateFunc: comp.f}))
...
func TestReturnsError(t *testing.T) {
	...
	require.NoError(t, s.AddSubTx(&SubTx{Name: "first", Func: f1, CompensateFunc: f2}))
...
func TestCompensateReturnsError(t *testing.T) {
	...
	require.NoError(t, s.AddSubTx(&SubTx{Name: "first", Func: (&mock{}).f, CompensateFunc: errCompensateFirst}))
	require.NoError(t, s.AddSubTx(&SubTx{Name: "second", Func: errFunc, CompensateFunc: errCompensateSecond}))
	...
	require.Error(t, err)
	_, err = logStore.GetSubTxLogsToCompensate(RandString())
	require.Error(t, err)
}
...
func TestAddStep(t *testing.T) {
	...
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: "hello", CompensateFunc: (&mock{}).f}), "func field is not a func, but string")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: (&mock{}).f, CompensateFunc: 25}), "func field is not a func, but int")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: func() {}, CompensateFunc: (&mock{}).f}), "func must have strictly one parameter context.Context")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: func(c int) {}, CompensateFunc: (&mock{}).f}), "func must have strictly one parameter context.Context")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: func(ctx context.Context) {}, CompensateFunc: (&mock{}).f}), "func must have at least one out value of type error")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: func(context.Context) int { return 10 }, CompensateFunc: (&mock{}).f}), "last out parameter of func must be of type error")

	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: (&mock{}).f, CompensateFunc: func() {}}), "compensate must have at least one parameter context.Context")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: (&mock{}).f, CompensateFunc: func(int) {}}), "first parameter of a compensate must be of type context.Context")
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: (&mock{}).f, CompensateFunc: func(context.Context) {}}), "compensate must must return single value of type error")

	f1 := func(context.Context) (string, int, error) { return "123", 0, nil }
	f2 := func(context.Context, int) error { return nil }
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: f1, CompensateFunc: f2}), "compensate in params not matched to func return values")

	f3 := func(context.Context) (string, int, error) { return "123", 0, nil }
	f4 := func(context.Context, string, string) error { return nil }
	require.EqualError(t, s.AddSubTx(&SubTx{Name: "first", Func: f3, CompensateFunc: f4}), "param 1 not matched in func and compensate")
